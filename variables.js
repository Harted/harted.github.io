...
// Colors
var color_1 = $('.color_1').css("background-color")
var color_2 = $('.color_2').css("background-color")
var color_3 = $('.color_3').css("background-color")
var color_4 = $('.color_4').css("background-color")
var color_back = $('.color_back').css("background-color")
